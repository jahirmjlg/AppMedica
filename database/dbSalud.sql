...
CREATE TABLE [Medi].[tbAlimentos] (
  ...
  [Alim_Calorias] decimal(4,2),
  [Alim_Proteinas] decimal(4,2),
  [Alim_Carbohidratos] decimal(4,2),
...
CREATE TABLE [Medi].[tbDiagnosticos] (
  ...
  [Diag_Peso] decimal(4,2) NOT NULL,
...
CREATE TABLE [Medi].[tbEntrenamientos] (
  ...
  [Entr_Peso] decimal(4,2),
  [Entr_Duracion] decimal(4,2),
